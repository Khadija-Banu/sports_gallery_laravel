...
<main class="main single-page">
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center mb-lg-0 mb-4">
                    ...
                    <h1 class="font-heading mb-40">
                        Best Online Sports Platform in Bangladesh
                    </h1>
                ...
                <div class="col-lg-6">
                    <img src="{{asset('ui/frontend')}}/assets/imgs/page/about-1.png" alt="">
                </div>
            </div>
        </div>
    </section>                
        ...
        <div class="container pt-25">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{asset('ui/frontend')}}/assets/imgs/page/avatar-4.jpg" alt="">
                        </div>
                        <div class="pl-30">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{asset('ui/frontend')}}/assets/imgs/page/avatar-5.jpg" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                B.Gates
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{asset('ui/frontend')}}/assets/imgs/page/avatar-1.jpg" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                B. Meyers
    ...
    <section class="section-padding">
        <div class="container">
            <h3 class="section-title mb-10 wow fadeIn animated text-center"><span>Featured</span> Clients</h3>
