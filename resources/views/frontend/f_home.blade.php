    ...
    <section class="banner-2 section-padding pb-0">
        <div class="container">
            <div class="banner-img banner-big wow fadeIn animated f-none">
                <img src="{{asset('ui/frontend')}}/assets/imgs/banner/download.jpg" alt="" style="width: 100%; height:300px">
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="{{route('frontend_product',$product->id)}}">
                                    <img  style="height: 200px" class="default-img" src="{{asset('storage/products/'. $product->product_image)}}" alt="">                                  
                                </a>
                            </div>
